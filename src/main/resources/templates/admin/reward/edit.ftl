...
<form class="layui-form" style="width:80%;">
    <input value="${reward.id}" name="id" type="hidden">
    <div class="layui-form-item">
        <label class="layui-form-label">获奖内容</label>
        <div class="layui-input-inline">
        <input  type="text" class="layui-input" value = "${reward.awardContent}" name="awardContent"  placeholder="请输入获奖内容">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input  type="text" class="layui-input" value = "${reward.studentName}" name="studentName"  placeholder="请输入获奖学生姓名">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <div id="content">${reward.teacherContent}</div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
...
<script>
    layui.use(['form','jquery','layer'],function(){
        ...
        form.on("submit(addReward)",function(data){
            ...
            //给角色赋值
            $.post("${base}/admin/reward/adminReplay",data.field,function(res){
