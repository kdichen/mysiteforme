...
public class BlogArticle extends DataEntity<BlogArticle> {
    ...
    @TableField("channel_patent_id")
    private String channelPatentId;
    /**
     * 排序值
     */
    ...
    public String getChannelPatentId() {
        return channelPatentId;
    }

    public void setChannelPatentId(String channelPatentId) {
        this.channelPatentId = channelPatentId;
    }
