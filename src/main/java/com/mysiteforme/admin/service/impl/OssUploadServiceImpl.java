...
public class OssUploadServiceImpl implements UploadService {
    ...
    private OSSClient getOSSClient() {
        return new OSSClient(getUploadInfo().getOssEndpoint(), getUploadInfo().getOssKeyId(), getUploadInfo()
                .getOssKeySecret());
    }
    ...
    public String upload(MultipartFile file) throws IOException, NoSuchAlgorithmException {
        ...
        try {
            ...
            PutObjectResult putResult = getOSSClient().putObject(getUploadInfo().getOssBucketName(), key.toString(),
                    is, metadata);
            //解析结果
    ...
    public Boolean testAccess(UploadInfo uploadInfo) {
        ...
        try {
            OSSClient ossClient = new OSSClient(uploadInfo.getOssEndpoint(), uploadInfo.getOssKeyId(), uploadInfo
                    .getOssKeySecret());
